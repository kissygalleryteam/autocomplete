...
gallery/autocomplete/1.0/build/rich
gallery/autocomplete/1.0/build/hot
gallery/autocomplete/1.0/build/index
gallery/autocomplete/1.0/build/multiple-min
 ...
 * RICH 包含UI所有交互逻辑
 */
KISSY.add('gallery/autocomplete/1.0/build/rich',function (S ,Node , Event , O){
    /**
     * @module autocomplete
...
KISSY.add('gallery/autocomplete/1.0/build/hot',function (S, Node , Event , Io , Tpl){
    /**
     自动完成组件
     @module autocomplete
 ...
 * @module autocomplete
 **/
KISSY.add('gallery/autocomplete/1.0/build/index',function (S , RichBase , AcBase, AcRich , AcHot) {
    /**
     * 通用的自动完成组件
     * @class Autocomplete
     * @constructor
